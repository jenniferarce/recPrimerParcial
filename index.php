	...
	<header id="header">
		...
		<nav>
			<ul id="main-nav" class="clearfix">
				<li><a onclick="mostrarLogin()" class="btn">Ingresar</a></li>
				<li><a onclick="mostrarDatos()" class="btn">Mi perfil</a> </li>
				<li><a onclick="mostrarListado()" class="btn">Ver listado</a> </li>
